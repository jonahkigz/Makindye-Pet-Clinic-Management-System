...
<div class="space-y-6">
    ...
    {{-- =========================================
        HERO SECTION
    ========================================== --}}
    <div class="rounded-2xl bg-gradient-to-r from-emerald-700 to-green-500 p-6 text-white shadow-lg">
...
<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    ...
    <a href="{{ route('payments.index') }}">
        <div class="bg-green-50 border border-green-100 rounded-2xl shadow-sm hover:shadow-lg transition duration-300 p-4 h-30 flex flex-col justify-between">
